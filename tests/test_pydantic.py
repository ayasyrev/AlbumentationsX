...
def test_non_negative_range_valid(non_negative_range: int | tuple[int, int]) -> None:
...
def test_symmetric_range_valid(symmetric_range: int | tuple[int, int]) -> None:
...
def test_non_negative_range_invalid(non_negative_range: int | tuple[int, int]) -> None:
    with pytest.raises(ValueError):
...
def test_one_plus_range_invalid(one_plus_range: int | tuple[int, int]) -> None:
    with pytest.raises(ValueError):
...
def test_zero_one_range_invalid(zero_one_range: int | tuple[int, int]) -> None:
    with pytest.raises(ValueError):
